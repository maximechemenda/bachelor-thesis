...
def eval_rouge(dec_dir, ref_dir):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        print("--MC: Executing rouge path from qmsum_oracle.py line 47")
...
mode = "train"
# Change to own path
# path = '../../originaldata/QMSum/ALL/jsonl/{}.jsonl'.format(mode)
path = '../../originaldata/QMSUM/Academic/jsonl/{}.jsonl'.format(mode)
data = []
with open(path) as f:
    for line in f:
