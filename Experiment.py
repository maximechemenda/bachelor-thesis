...
class Experiment(object):
    ...
    def train(self):
        ...
        while True:
            ...
            print(f"Self.decay_num: {self.decay_num}. Config.max_decay_num: {config.max_decay_num}")
    ...
    def build_optim(self):
        ...
        for scope in self.scopes.keys():
            ...
            print("FINISHED RUNNING BUILD_OPTIM()")
    ...
    def train_epoch(self, epoch_id):
        ...
        print(f"Length of data loader: {len(train_dataloader)}")
